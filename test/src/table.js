...
function Table() {
    ...
    <div>
        ...
        <form onSubmit={onformsumbit}>
            <input type="text" placeholder='Enter a Name' name="fullname" required="required" value={dumidata.fullname} onChange={onchangeinput} required="required"/>
            <input type="text" required="required" value={dumidata.userid} placeholder='Enter a UserID' name="userid" onChange={onchangeinput} required="required" />
            <input type="text" placeholder='Enter a Product'required="required" value={dumidata.product} required="required" name="product" onChange={onchangeinput}/>
